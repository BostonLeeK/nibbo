...
export const I18N = {
  uk: {
    ...
    profile: {
      ...
      mcpSectionTitle: "Доступ для MCP (читання)",
      mcpSectionHint:
        "Створи ключ і встав його в Cursor як NIBBO_MCP_READ_TOKEN разом із URL свого Nibbo. Показується один раз — збережи в надійному місці.",
      ...
      mcpRevokeConfirm: "Відкликати цей ключ? MCP з ним перестане працювати.",
  ...
  en: {
    ...
    profile: {
      ...
      mcpSectionTitle: "MCP access (read-only)",
      mcpSectionHint:
        "Create a key and put it in Cursor as NIBBO_MCP_READ_TOKEN with your Nibbo URL. It is shown only once — store it safely.",
      ...
      mcpCopied: "Copied",
      mcpRevoke: "Revoke",
      mcpRevokeConfirm: "Revoke this key? MCP using it will stop working.",
