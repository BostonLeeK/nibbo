...
import { APP_LANGUAGE_COOKIE_KEY, I18N, type AppLanguage } from "@/lib/i18n";
...
function resolveLanguage(cookieValue: string | undefined): AppLanguage {
  return cookieValue === "en" ? "en" : "uk";
}
...
export default async function TasksHistoryPage() {
  ...
  const language = resolveLanguage((await cookies()).get(APP_LANGUAGE_COOKIE_KEY)?.value);
